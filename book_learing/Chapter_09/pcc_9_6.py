...
class IceCreamStand(Restaurant):
    ...
    def describe_icecream_flavors(self):
        print(f'Your icecream flavors is {self.flavors}')

    #编写选择冰淇凌口味的方法
    def choose_icecream_flavors(self , flavors):
        self.flavors=flavors

icecream_stand1 = IceCreamStand('DQ' , 'chocolate icecream')
icecream_stand1.describe_icecream_flavors()
icecream_stand1.choose_icecream_flavors('chocolate')
icecream_stand1.describe_icecream_flavors()
